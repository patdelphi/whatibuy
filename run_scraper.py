...
from scrapers.xianyu import scrape_xianyu

if __name__ == "__main__":
    print("-" * 50)
    print("请选择抓取平台：")
    print("1. 淘宝 (Taobao) - 包含闲鱼订单")
    print("2. 京东 (JD)")
    print("3. 闲鱼 (Xianyu) - 独立抓取 (测试版)")
    print("-" * 50)
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['1', '2', '3']:
        ...
        platform_choice = input("请输入选项 (1/2/3): ").strip()
        mode_arg = None
